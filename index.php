    ...
    <!-- <footer class="footer">
        <div class="container">
            <div class="row col-12">
                <div class="row col-4 mr-auto">
                    <h1>Contáctenos</h1>
                </div>
                <div class="row col-4 text-center">
                    <a href="#"><img src="img/logo-bla.png" alt=""></a>
                </div>
                <div class="redes row col-4 ml-auto">
                    <ul>
                        <li><a href="" class="text-reset"><i class="marg fab fa-twitter"></i></a></li>
                        <li><a href="" class="text-reset"><i class="marg fab fa-facebook-f"></i></a></li>
                ...
                <div class="redes">
                    <ul class="col-sm-12 col-md-4 col-lg-4 list-unstyled">
                        <li class="red-soci d-flex justify-content-center">
                            <a href="" class="text-reset"><i class="marg fab fa-twitter"></i></a>
                            <a href="" class="text-reset"><i class="marg fab fa-facebook-f"></i></a>
